...
- (void)startRippleAnimation
{
    ...
    NSTimer *animationTimer = [NSTimer scheduledTimerWithTimeInterval:0.7 target:self selector:@selector(rippleAnimation) userInfo:nil repeats:YES];
